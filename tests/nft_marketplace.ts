...
describe("nft_marketplace", () => {
  ...
  let chainlinkFeed: anchor.web3.PublicKey = new anchor.web3.PublicKey(
  ...
  it("5. Token Setup", async () => {
    ...
    [token_config_pda, token_config_pda_bump] =
    ...
    [token_vault_pda, token_vault_pda_bump] =
      await anchor.web3.PublicKey.findProgramAddress(
        [
    ...
    assert.strictEqual(
      config_fetch_two.usdcMint.mintKey.toString(),
      usdcMintPubkey.toString()
    );
